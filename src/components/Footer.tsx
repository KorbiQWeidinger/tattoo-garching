          ...
          <div className='space-y-4'>
            ...
            <ul className='space-y-3 text-sm'>
              <li>
                ...
                >
                  <svg
                    className='w-5 h-5 mt-0.5 text-zinc-500 group-hover:text-purple-600 transition-colors'
                    fill='none'
                    stroke='currentColor'
                    viewBox='0 0 24 24'
                  >
              ...
              <li>
                ...
                >
                  <svg
                    className='w-5 h-5 text-zinc-500 group-hover:text-purple-600 transition-colors'
                    fill='none'
                    stroke='currentColor'
                    viewBox='0 0 24 24'
                  >
