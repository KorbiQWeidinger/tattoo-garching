...
const coverUpImages = Array.from(
  { length: 4 },
  (_, i) => `${BASE_PATH}/galerie/cover-up/cover-${i + 1}.webp`
);

const studioImages = Array.from(
  { length: 8 },
  (_, i) => `${BASE_PATH}/galerie/studio/studio-${i + 1}.png`
);
    ...
    <Layout>
      ...
      <div className='relative py-24 sm:py-32 bg-zinc-900'>
        <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          <h1 className='text-4xl sm:text-5xl lg:text-6xl font-light text-white mb-6'>Galerie</h1>
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16'>
        <GallerySection title='Tattoos' images={tattooImages} onImageClick={setLightboxImage} />

        <GallerySection title='Cover Up' images={coverUpImages} onImageClick={setLightboxImage} />

        <GallerySection title='Studio' images={studioImages} onImageClick={setLightboxImage} />
      </div>
