    ...
    <div className='min-h-screen flex flex-col'>
      ...
      <section className='relative min-h-screen flex items-center'>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center'>
            ...
            <div className='text-white space-y-6'>
              ...
              <div className='space-y-4 text-gray-200 text-base sm:text-lg leading-relaxed'>
                <p>
                  <strong className='text-white'>Tattoo Lounge by Petra -</strong> Ihr Tattoo Studio
                  in Garching bei München. Hier wird nach strengsten Hygienevorschriften und mit
                  zertifizierten Farben gearbeitet.
                </p>

                <p>
                  Wenn ihr eine Idee habt, aber nicht wisst wie ihr diese umsetzen sollt, bin ich
                  gerne bereit, einen Entwurf für euch zu zeichnen. Freundliche und ausführliche
        ...
        <div className='lg:hidden absolute bottom-0 left-0 w-64 opacity-30 pointer-events-none'>
          <img src={`${BASE_PATH}/tattoo-one.png`} alt='' className='w-full h-auto' />
        </div>
      </section>
